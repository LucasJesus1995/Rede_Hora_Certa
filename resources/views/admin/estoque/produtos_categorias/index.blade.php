...
@section('content')
  ...
  <div class="card">
    <div class="card-heading">
      <h2>
        Categoria de Produtos - {{Lang::get('app.listagem-de-dados')}}
      </h2>
    </div>
       <div class="card-tools">
            <a href="{{ route('produtos_categorias.create') }}" class="btn btn-default">{{Lang::get('app.novo-registro')}}</a>
        </div>
    <div class="card-body bg-light lt">
        ...
        <div id="box-grid">
            ...
            <table class="table table-striped table-responsive table-bordered  bg-light " >
                ...
                <tbody>
                    @foreach($produtos_categorias AS $row)
                        <tr class="grid-status-{{$row->ativo}}">
                            ...
                            <td nowrap>
                                ...
                                <a href="{{ route('produtos_categorias.edit', $row->id) }}" title="Editar"  class="btn btn-rounded btn-xs btn-info waves-effect"><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
