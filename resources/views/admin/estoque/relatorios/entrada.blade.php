...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-body bg-light " id="">
       ...
       {!!Form::model('Produtos', array('url' => route('estoque.relatorios.entrada_excel'), 'class' => 'form-vertical', 'autocomplete' => 'off'))!!}
        <div class="row">
            <div class="col-md-12">
              <div class="row">                
                <div class="col-md-6">
...
<script>
    ...
    function gerar(){
      ...
      // alert(token)
      $.post( "/admin/estoque/relatorios/entrada_excel", { _token: $("input[type=hidden][name=_token]").val(), data_inicial: $('#id-field-data_inicial').val(), data_final: $('#id-field-data_final').val(), tela: true })
        .done(function( data ) {
            $('#response').html(data)
      });
    }
