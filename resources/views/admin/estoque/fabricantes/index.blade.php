...
@section('content')
  ...
  <div class="card">
    <div class="card-heading">
      <h2>
        Fabricantes de Produtos - {{Lang::get('app.listagem-de-dados')}}
      </h2>
    </div>
       <div class="card-tools">
            <a href="{{ route('estoque.fabricantes.create') }}" class="btn btn-default">{{Lang::get('app.novo-registro')}}</a>
        </div>
    <div class="card-body bg-light lt">
        ...
        <div id="box-grid">
                    ...
                    @foreach($fabricantes AS $row)
                        <tr class="grid-status-{{$row->ativo}}">
                            ...
                            <td nowrap>
                                ...
                                <a href="{{ route('estoque.fabricantes.edit', $row->id) }}" title="Editar"  class="btn btn-rounded btn-xs btn-info waves-effect"><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
           ...
           {{-- <a href="{{ route('estoque.relatorios.fabricantes') }}" class="btn btn-success">Posição Estoque Geral</a> --}}
