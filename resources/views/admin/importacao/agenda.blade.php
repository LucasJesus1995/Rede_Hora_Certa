...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!! Form::model(null,array('url' => '/admin/importacao/agenda','enctype'=>'multipart/form-data')) !!}
            {!! csrf_field() !!}
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    {!!Form::selectField('equipamento', [],"Equipamento", null, array('class' => 'form-control chosen equipamento'))!!}
...
@section('script')
    ...
    setTimeout( function() {
    $(".linha_cuidado").change();
    }, 1000 );


    loadingDataGridAgendaImportacao();
@stop
