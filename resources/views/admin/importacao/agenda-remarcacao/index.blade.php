...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!! Form::model(null,array('url' => '/admin/importacao/agenda-remarcacao','enctype'=>'multipart/form-data')) !!}
            {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    {!! Form::fileField('file', 'Arquivo de Importação (xlsx)') !!}
                </div>
...
@section('script')
    ...
    loadingDataGridAgendaImportacaoRemarcacao();
@stop
