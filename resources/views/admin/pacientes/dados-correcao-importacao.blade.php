...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!! Form::model(null,array('url' => '/admin/pacientes/dados-correcao-importacao','enctype'=>'multipart/form-data')) !!}
            {!! csrf_field() !!}

            <div class="row">
                <div class="col-md-10">
                    {!! Form::fileField('file', 'Arquivo de Importação (csv)') !!}
                </div>
                <div class="col-md-2">
...
@section('script')
    ...
    loadingDataGridPacienteImportacao();
@stop
