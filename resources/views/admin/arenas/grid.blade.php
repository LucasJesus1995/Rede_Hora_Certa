            ...
            <tbody>
                @foreach($grid AS $row)
                    <tr class="grid-status-{{$row->ativo}}">
                        ...
                        <td>
                            @if(!empty($row->alias))
                                <strong>{{$row->alias}}</strong><br />
                            @endif
                            {{$row->nome}}
                        </td>
                        <td>{{$row->cnes}}</td>
                        <td nowrap>
                        <a href="/admin/arenas/entry/{{$row->id}}"  class="btn btn-rounded btn-xs btn-info waves-effect"><i class="fa fa-edit"></i></a>
                        <a href="/admin/arenas/delete/{{$row->id}}" class="btn-grid-delete btn btn-rounded btn-xs btn-danger waves-effect"><i class="fa fa-remove"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
