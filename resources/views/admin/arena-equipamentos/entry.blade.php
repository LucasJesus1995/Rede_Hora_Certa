...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!!Form::model($entry, array('url' => '/admin/arena-equipamentos', 'class' => 'form-vertical'))!!}
            {!!Form::hidden('id')!!}

            <div class="row">
                <div class="col-md-5">{!!Form::selectField('arena', \App\Arenas::Combo() , 'Arena', null, array('class' => 'form-control chosen'))!!}</div>
                <div class="col-md-5">{!!Form::textField('nome', 'Nome', null, array('class' => 'form-control'))!!}</div>
                <div class="col-md-2">{!! Form::selectField('ativo', \App\Http\Helpers\Util::Ativo(), Lang::get('app.ativo'), 1, array('class' => 'form-control chosen')) !!}</div>
