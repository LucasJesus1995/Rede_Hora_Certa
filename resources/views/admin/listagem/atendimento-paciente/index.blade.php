...
@section('content')
    <div class="card">
        <div class="card-heading">
            <h2>
                Listagem de dados (Atendimentos > Pacientes)
            </h2>
            <small></small>
        </div>
        ...
        <div class="card-body bg-light lt">
            ...
            {!!Form::open( array('class' => 'form-vertical','method'=>'POST','id'=>'listagem-atendimento-paciente'))!!}
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-1">
                    <div class="align-center">
                        <div class="form-group">
                            ...
                            <a id="btn-listagem-atendimento-paciente" class="btn  col-md-12 btn-info waves-effect"><i class="fa fa-search"></i></a>
                        </div>
                    </div>
                </div>
            </div>
