...
@section('content')
  ...
  <div class="card">
    <div class="card-heading">
      ...
      <small>{{Lang::get('description.cbo')}}</small>
    </div>
    ...
    <div class="card-body bg-light " id="">
       ...
       {!!Form::model($entry, array('url' => '/admin/cbo', 'class' => 'form-vertical'))!!}
       {!!Form::hidden('id')!!}
        <div class="row">
            <div class="col-md-8">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  {!!Form::selectField('ativo', array('1' => Lang::get('app.sim'), '0' => Lang::get('app.nao')), Lang::get('app.ativo'), null, array('class' => 'form-control'))!!}</div>
              </div>
            </div>           
            <div class="col-md-4">
