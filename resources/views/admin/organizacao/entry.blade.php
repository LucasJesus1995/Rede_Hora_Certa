...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!!Form::model($entry, array('url' => '/admin/organizacao', 'class' => 'form-vertical'))!!}
            {!!Form::hidden('id')!!}
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5">
                            {!!Form::selectField('sub_grupo', \App\SubGrupos::Combo(), 'Sub Grupo', null, array('class' => 'form-control chosen','id'=>'lote'))!!}
                        </div>
                        <div class="col-md-2">
                            {!!Form::textField('codigo', Lang::get('app.codigo'), null, array('class' => 'form-control'))!!}
                        </div>
                        <div class="col-md-5">
                            {!!Form::textField('descricao', Lang::get('app.descricao'), null, array('class' => 'form-control'))!!}
                        </div>
                    </div>
                </div>
            </div>
