...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body bg-light " id="">
            ...
            {!!Form::model($entry, array('url' => '/admin/sub-grupos', 'class' => 'form-vertical'))!!}
            {!!Form::hidden('id')!!}
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5">
                            {!!Form::selectField('grupo', \App\Grupos::Combo(), 'Grupo', null, array('class' => 'form-control chosen','id'=>'lote'))!!}
                        </div>
                        <div class="col-md-2">
