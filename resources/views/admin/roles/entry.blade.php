...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-body bg-light " id="">
       ...
       {!!Form::model($entry, array('url' => '/admin/perfil', 'class' => 'form-vertical'))!!}
       {!!Form::hidden('id')!!}
        <div class="row">
            <div class="col-md-6">{!!Form::textField('role_title', Lang::get('app.nome'), null, array('class' => 'form-control'))!!}</div>
            <div class="col-md-6">{!!Form::textField('role_slug', Lang::get('app.slug'), null, array('class' => 'form-control'))!!}</div>
        </div>
        <div class="row">
            <div class="col-md-12">
