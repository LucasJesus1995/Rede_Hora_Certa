...
@section('content')
    <div class="card">
        <div class="card-heading">
            <h2>
                Relatório de Produção (Indicadores)
            </h2>
            <small></small>
            <hr />
            <div class="row" id="relatorio-producao-indicadores">
                <div class="col-md-6">
                    {!!Form::selectField('lote', \App\Lotes::Combo(), Lang::get('app.lote'), null, array('class' => 'form-control chosen','id'=>'lote'))!!}
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <a id="btn-gerar-relatorio-producao-indicadores" href="javascript: void(0)" class="btn btn-success form-control">{{Lang::get('app.gerar-relatorio')}}</a>
                    </div>
                </div>
