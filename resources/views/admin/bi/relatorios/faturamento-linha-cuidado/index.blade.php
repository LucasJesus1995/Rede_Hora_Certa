...
@section('content')
    ...
    <div class="card">
        <div class="card-heading">
            <h2>
                Relatório de procedimentos por especialidade e agenda
            </h2>
            <small></small>
            <hr />
            ...
            <div id="relatorio-previsao-faturamento">
                ...
                <div class="row">
                    <div class="col-md-4">
                        {!!Form::selectField('lote', \App\Lotes::Combo(), Lang::get('app.lote'), null, array('class' => 'form-control combo-arena chosen','id'=>'arena'))!!}
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-1">
                        <div class="form-group" style="margin-top: 24px">
                            <button id="btn-faturamento-linha-cuidado" class="btn btn-success waves-effect col-md-12 col-xs-12" type="button">Gerar</button>
                        </div>
                    </div>
                </div>
