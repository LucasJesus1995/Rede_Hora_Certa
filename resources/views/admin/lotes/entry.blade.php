...
@section('content')
  ...
  <div class="card">
    <div class="card-heading">
      ...
      <small>{{Lang::get('description.lote')}}</small>
    </div>
    ...
    <div class="card-body bg-light " id="">
       ...
       {!!Form::model($entry, array('url' => '/admin/lotes', 'class' => 'form-vertical'))!!}
       {!!Form::hidden('id')!!}
        <div class="row">
            <div class="col-md-6">{!!Form::textField('nome', Lang::get('app.nome'), null, array('class' => 'form-control'))!!}</div>
            <div class="col-md-6">{!!Form::textField('codigo', Lang::get('app.codigo'), null, array('class' => 'form-control'))!!}</div>
        </div>
        <div class="row">
            <div class="col-md-12">
