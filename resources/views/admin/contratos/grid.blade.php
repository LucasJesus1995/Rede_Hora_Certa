            ...
            <tbody>
                @foreach($grid AS $row)
                    <tr class="grid-status-{{$row->ativo}}">
                        ...
                        <td>{{$row->nome}}</td>
                        <td nowrap>
                            <a href="/admin/contratos/procedimentos/{{$row->id}}" class="btn btn-rounded btn-xs btn-success btn-contrato-procedimentos waves-effect"><i class="fa fa-list"></i></a>
                            <a href="/admin/contratos/entry/{{$row->id}}"  class="btn btn-rounded btn-xs btn-info waves-effect"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
