...
<div style='page-break-before:always;' class="kit-impressao">
                ...
                <tr>
                    <td colspan="6">
                        <table width="100%" class="">
                            <tr>
                                <td style="text-align: center" width="16.5%"><img src="src/image/escala-dor/sem-dor.png"
                                                                                  width="35px"/><span
                                            style="font-size: 8px !important; display: block">Sem dor</span></td>
                                <td style="text-align: center" width="16.5%"><img
                                            src="src/image/escala-dor/dor-leve.png" width="35px"/><span
                                            style="font-size: 8px !important; display: block">Dor leve</span></td>
                                <td style="text-align: center" width="16.5%"><img
                                            src="src/image/escala-dor/sem-dor-2.png" width="35px"/><span
                                            style="font-size: 8px !important; display: block">Suportável</span>
                                </td>
                                <td style="text-align: center" width="16.5%"><img
                                            src="src/image/escala-dor/moderada.png" width="35px"/><span
                                            style="font-size: 8px !important; display: block">Moderada</span></td>
                                <td style="text-align: center" width="16.5%"><img src="src/image/escala-dor/forte.png"
                                                                                  width="35px"/><span
                                            style="font-size: 8px !important; display: block">Forte</span></td>
                                <td style="text-align: center" width="16.5%"><img
                                            src="src/image/escala-dor/insuportavel.png" width="35px"/><span
                                            style="font-size: 8px !important; display: block">Insuportável</span>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <div class="bloco" style="margin: 0; margin-top: 10px;">
        <h2 style="text-align: left; margin: 0">ANOTAÇÃO DE ENFERMAGEM</h2>
        <div style="margin: 22px 5px; line-height: 22px">
            <hr/>
            @for($i = 0; $i < 3; $i++)
                <br/>
