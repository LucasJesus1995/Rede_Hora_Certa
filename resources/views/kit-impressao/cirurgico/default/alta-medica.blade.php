...
<div style='page-break-before:always;' class="kit-impressao">
    ...
    <h1 class="title">ALTA MÉDICA</h1>

    <table width="100%">
        <tr>
            @if(!in_array($agenda->linha_cuidado, [9, 47]))
                <td width="50%">
                    <div class="bloco" style="margin: 0;">
                        <h2 style="text-align: left">Motivo de internação</h2>
                        <div style="margin: 10px 5px; line-height: 17px; height: 20px; font-style: italic ">
                            @if($agenda->linha_cuidado == 9)
                                Interna para procedimento ambulatorial de varizes
                            @else
                                Interna para procedimento cirúrgico
                            @endif
                        </div>
                    </div>
                </td>
            ...
            <td width="50%">
                <div class="bloco" style="margin: 0; ">
                    <h2 style="text-align: left">Intercorrências</h2>
                    <div style="margin: 10px 5px; line-height: 17px; height: 20px; font-style: italic ">
    ...
    <div class="bloco" style="margin: 0; margin-top: 10px;">
        <h2 style="text-align: left">Procedimentos realizados</h2>
        <div style="margin: 10px 5px; line-height: 17px; height: 50px; font-style: italic ">
    ...
    <div class="bloco" style="margin: 0; margin-top: 10px;">
        ...
        <div style="margin: 10px 5px; line-height: 17px; height: 20px; font-style: italic ">
            ...
            @elseif($agenda->linha_cuidado == 47)
                1. Cuidados com a pós cirúrgico, coleta de espermograma e retorno para reavaliação
            @else
    ...
    <table width="100%">
        <tr>
            ...
            <td width="50%">
                @if(in_array($agenda->linha_cuidado, [45, 47]))
                    <div class="bloco" style="margin: 0; margin-top: 10px;">
    ...
    @if(!in_array($agenda->linha_cuidado, [47]))
        <div style="margin-top: 60px">
            @include('elements.layout.kit.cirurgico.assinatura-carimbo-medico')
        </div>
    @endif
        ...
        <div style="margin: 10px 5px; line-height: 17px; font-style: italic ">
            @if(in_array($agenda->linha_cuidado, [19, 45]))
                @if(in_array($sub_especialidade, [2]))
                    ...
                    - Pingar os colírios nos horários, exceto durante a madrugada (agitá-los levemente antes do uso, e não encostar a ponta dos colírios na mãos, olhos, rosto ou objetos);<br>
                    - Lavar as mãos antes de pingar os colírios;<br>
                    - Não dormir do lado do olho operado por 07 dias;<br>
                    - É comum ter dor e sensação de areia nos olhos, durante os três primeiros dias, nestes casos tomar a mesma remédio que usa para dor de cabeça;<br>
                ...
                @else
                    ...
                    • Pingue os colírios de acordo com a orientação médica (mesmo com o curativo levante-o e pingue);<br/>
            ...
            @if(in_array($agenda->linha_cuidado, [9, 49]))
                <strong>Em Casa</strong>: Se a residência tem escadas não há nenhum problema em subi-las devagar. Procurar ficar um pouco mais em repouso nos 2 primeiros dias após a cirurgia: deitado
                ou sentado com apoio sob as pernas. Apesar disso, você está liberado para movimentar-se pela casa,
                ir ao banheiro,
                fazer refeições, atender ao telefone, etc. e deve andar de 10 a 15 minutos cada 1 hora. Depois, à medida que se sentir bem este tempo pode ir sendo aumentado progressivamente;
                Não molhar o curativo. Retirá-los após 1 dias da cirurgia e continuar a usar meia elástica, retirar ao dormir;<br/>
            ...
            @if(in_array($sub_especialidade, [4]))
                . É importante seguir todas as orientações dadas tais como cuidados com a ferida, limpeza e uso de medicamentos analgésicos ou anti-inflamatórios para a dor, prescritos pelo médico;
                <br/>
            ...
            @if(in_array($sub_especialidade, [5]) || in_array($agenda->linha_cuidado, [46]))
                . É importante seguir todas as orientações dadas, tais como: cuidados com a ferida, limpeza e uso de medicamentos (se indicado);<br/>
                . Você poderá retornar a atividades leves no dia de sua cirurgia, de acordo com a orientação médica;<br/>
                · Certifique-se de manter o local da incisão limpo e bem protegido de uma possível lesão;<br/>
                . Tente limitar o movimento que possa forçar o ferimento e as suturas;<br/>
                . Em caso de dor, usar o analgésico (Dipirona, Paracetamol) de acordo com preferência;<br/>
                . Não pegar peso;<br/>
            ...
            • <strong>Em caso de dúvidas entre em contato Telefone @if(!empty($arena->telefone)) {!! \App\Http\Helpers\Mask::telefone($arena->telefone) !!}   @else _____ ________-________  @endif
                <br/><br/></strong>

            Retorno pós cirúrgico ______/ ______/____________ às ____________________
        </div>
    </div>
