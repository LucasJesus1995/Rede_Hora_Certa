...
class AtendimentoProcedimentosQuantidadeCommand extends Command
{
    protected $signature = 'cies:atendiemnto-procedimentos-quantidade';
    protected $description = 'Ajusta a quantidade';
